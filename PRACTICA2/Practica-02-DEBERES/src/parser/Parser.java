...
public class Parser {
	...
	public final static int MENORIGUAL = 273;
	
	public final static int MAYORIGUAL = 274;
	
	public final static int EQUIVALENTE = 275;
	
	public final static int DISTINTO = 276;
	
	public final static int OR = 277;
	
	public final static int AND = 278;
