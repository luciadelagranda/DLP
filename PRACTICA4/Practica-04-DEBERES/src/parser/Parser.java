...
{List<VarDefinition> variables = new ArrayList<VarDefinition>();
										 for(String ident : ((List<String>)val_peek(3)))
										 	variables.add(new VarDefinition(scanner.getLine(), scanner.getColumn(), (String)ident ,(Type)val_peek(1)));	
										 yyval = variables;
										 }
break;
case 40:
...
{yyval = val_peek(1); ((List<RecordField>)yyval).addAll((List<RecordField>)val_peek(0));}
break;
case 52:
//#line 180 "../../src/parser/parser.y"
{List<RecordField> variables = new ArrayList<RecordField>();
    													 for(String ident : ((List<String>)val_peek(3)))
        													variables.add(new RecordField(scanner.getLine(), scanner.getColumn(),((String) ident), (Type)val_peek(1)));
 														 yyval = variables;
														}
break;
case 53:
...
{yyval = new Logical(scanner.getLine(), scanner.getColumn(), null,"!", (Expression)val_peek(0));}
break;
case 65:
