...
public class TypeCheckingVisitor implements Visitor{
	...
	public Object visit(Assignment assignment, Object param) {
		...
		if(!assignment.getLeft().getLValue()) {
			String msg = "Una asignación no puede ir a la izquierda. Linea " + assignment.getLine() + " columna " + assignment.getColum();
	...
	public Object visit(FieldAccess fieldAccess, Object param) {
		fieldAccess.getExp1().accept(this, null);
	...
	public Object visit(Indexin indexin, Object param) {
		indexin.getExp1().accept(this, null);
		indexin.getExp2().accept(this, null);
